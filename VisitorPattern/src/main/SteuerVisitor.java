...
class SteuerVisitor implements Visitor {
    ...
    public String visit(Alkohol alkohol) {
        ...
        return df.format((alkohol.getPrice() * .18) + alkohol.getPrice());
    }
    ...
    public String visit(Tabak tabak) {
        ...
        return df.format((tabak.getPrice() * .32) + tabak.getPrice());
    }
